...
def Pacejka52_lat(Fz,alpha,IA,Fz0,params): 
    ...
    Shy = (pa.PHY1 + pa.PHY2 * dfz) + (Kyg0 * gamma - Svyg) / (Kya + 0.001)
    alphay = alpha + Shy
    ...
    Svy = Fz * (pa.PVY1 * pa.PVY2 * dfz) + Svyg
...
#Mz Aligning Torque
def Pacejka52_aligning(Fz,Fz0,alpha,Fy0,params):
...
def Pacejka52_long_comb(Fz,Fz0,alpha,SL,Fx0,params): #Fx0 = Fx aus Pacejka_long
    if params == 'Indy':
        import parameter.Pacejka_Params_Indy as pa
    elif params == 'pkw':
        import parameter.Pacejka_Params_pkw as pa
...
def Pacejka52_lat_comb(Fz,Fz0,alpha,SL,Fy0,params): #Fy0 = Fy aus Pacejka_lat
    if params == 'Indy':
        import parameter.Pacejka_Params_Indy as pa
    elif params == 'pkw':
        import parameter.Pacejka_Params_pkw as pa
...
def Pacejka52_alinging_comb(Fz,Fz0,alpha,SL,Fx,Fy,params):
    if params == 'Indy':
        import parameter.Pacejka_Params_Indy as pa
    elif params == 'pkw':
        import parameter.Pacejka_Params_pkw as pa
...
def Pacejka5_long(SL,Fz,params):
    if params == 'Indy':
        import parameter.Pacejka_Params_Indy as pa
    elif params == 'pkw':
        import parameter.Pacejka_Params_pkw as pa
...
#Fy
def Pacejka5_lat(alpha,Fz,params):
    if params == 'Indy':
        import parameter.Pacejka_Params_Indy as pa
    elif params == 'pkw':
        import parameter.Pacejka_Params_pkw as pa
